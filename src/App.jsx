    ...
    <>
      ...
      <section id="landing-content">
        <div className="content-grid">
          <div className="content-card">
            <h2>The Future of Web Creation</h2>
            <p>Forma leverages advanced artificial intelligence to transform your ideas into fully functional, production-ready websites in seconds. No more template constraints—just raw creativity powered by the latest in AI technology.</p>
          </div>

          <div className="content-card">
            <h2>Modern Tech Stack</h2>
            <p>Every site generated by Forma uses a modern stack including React, clean CSS, and optimized assets. The output is a single, self-contained HTML file that's easy to host and modify, ensuring you have total ownership of your code.</p>
          </div>
        </div>
        ...
        <div className="detailed-section">
          ...
          <div className="steps">
            <div className="step">
              ...
              <h3>Describe</h3>
              <p>Type in what kind of website you need. Be as specific as you want about features and aesthetics.</p>
            </div>
            <div className="step">
              <span className="step-number">02</span>
              <h3>Generate</h3>
              <p>Our AI engine processes your request, designing and coding the site from scratch in real-time.</p>
            </div>
            <div className="step">
              <span className="step-number">03</span>
              <h3>Deploy</h3>
              <p>Review your site, download the index.html, and host it anywhere in just a few clicks.</p>
            </div>
          </div>
        </div>
        ...
        <div className="faq-section">
          ...
          <div className="faq-item">
            <h3>Is the code mine?</h3>
            <p>Yes, once the site is generated and downloaded, you own the code. You can host it, modify it, or use it for any project without restrictions.</p>
          </div>
          <div className="faq-item">
            <h3>Which AI model powers Forma?</h3>
            <p>Forma uses state-of-the-art large language models optimized for code generation and UI/UX design to ensure high-quality outputs.</p>
          </div>
          <div className="faq-item">
            <h3>Do I need to know how to code?</h3>
            <p>Not at all. Forma is designed for everyone, from designers wanting a quick prototype to entrepreneurs launching their first business.</p>
          </div>
        </div>
      </section>
      ...
      <div id="privacy" style={{ display: isPrivacyOpen ? 'flex' : 'none' }}>
        ...
        <main>
          ...
          <p>
            Thank you for using Forma (“we”, “us”, or “our”). We respect your privacy.
