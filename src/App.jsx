...
export default function App() {
  ...
  return (
    <>
      ...
      <div id="privacy" style={{ display: isPrivacyOpen ? 'flex' : 'none' }}>
        <button id="close-privacy" onClick={togglePrivacy}>&times;</button>
        <main>
      ...
      <footer id="footer">
        <a id="github-link" href="https://github.com/TopMyster" target="_blank">©2025 TopMyster</a>
        <a id="privacy-link" onClick={togglePrivacy}>Privacy Policy</a>
      </footer>
    </>
  )
}
